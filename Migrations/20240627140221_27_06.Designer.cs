...
namespace Alarm_Project.Migrations
{
    ...
    [Migration("20240627140221_27_06")]
    partial class _27_06
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Alarm_Project.Models.Alarm", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AlarmType = "Warning",
                            Time = new DateTime(2024, 6, 27, 17, 2, 20, 855, DateTimeKind.Local).AddTicks(1814),
            ...
            modelBuilder.Entity("Alarm_Project.Models.Alarm", b =>
                {
                    b.HasOne("Alarm_Project.Models.Users", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Alarm_Project.Models.AlarmSettings", b =>
                {
                    b.HasOne("Alarm_Project.Models.Alarm", "Alarm")
                        .WithOne("AlarmSettings")
                        .HasForeignKey("Alarm_Project.Models.AlarmSettings", "AlarmId")
